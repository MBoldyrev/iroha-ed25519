...
ED25519_EXPORT int sha512_init(sha_context *context) {
  sph_sha512_init((void *) context);
  return ED25519_SUCCESS;
}

ED25519_EXPORT int sha512_update(sha_context *context, const unsigned char *in,
                                 unsigned long long inlen) {
  sph_sha512((void *) context, in, inlen);
  return ED25519_SUCCESS;
}

ED25519_EXPORT int sha512_final(sha_context *context, unsigned char *out) {
